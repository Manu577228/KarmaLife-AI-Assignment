Goal:
As a mobile web app designer, your task is to build a mobile-optimized web app on React JS to verify the bank account of a user and save it to the backend after successful verification. The app will be used by Uber cab drivers who may have limited education and language proficiency. The app should be designed to be easy to use and intuitive for such users.

Requirements:
-To build a React JS app that is optimized for mobile web
